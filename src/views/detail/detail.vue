<template>
  <div class="detail top-page" ref="detailRef">
    <tab-control class="tabs" v-if="showTabControl" :titles="names"  @tabItemClick="tabClick" ref="tabControlRef" />
    <van-nav-bar
      title="房屋详情"
      left-text="旅途"
      left-arrow
    ...
    <div class="main" v-if="mainPart" v-memo="[mainPart]">
      ...
      <detail-lanlor name="房东" :ref="getSectionRef" :landlord="mainPart.dynamicModule.landlordModule" />
...
import DetailLanlor from './cpns/detail_04-landlord.vue'
